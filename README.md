...
- [Minik8s 验收文档](#minik8s-验收文档)
  - [1. 总体架构与软件栈](#1-总体架构与软件栈)
  - [2. 组员分工和贡献度占比](#2-组员分工和贡献度占比)
  - [3. 项目开发](#3-项目开发)
    - [3.1 分支介绍](#31-分支介绍)
    - [3.2 CI/CD介绍](#32-cicd介绍)
      - [3.2.1 软件栈选择](#321-软件栈选择)
      - [3.2.2 流程与配置](#322-流程与配置)
    - [3.3 软件测试方法](#33-软件测试方法)
    - [3.4 新功能开发流程](#34-新功能开发流程)
  - [4. 系统架构和组件功能](#4-系统架构和组件功能)
    - [4.1 APIObject抽象](#41-apiobject抽象)
      - [4.1.1 Node](#411-node)
      - [4.1.2 Pod](#412-pod)
      - [4.1.3 Service](#413-service)
      - [4.1.4 ReplicaSet](#414-replicaset)
      - [4.1.5 HorizontalPodAutoscaler](#415-horizontalpodautoscaler)
      - [4.1.6 DNSRecord](#416-dnsrecord)
      - [4.1.7 Job](#417-job)
      - [4.1.8 Function](#418-function)
      - [4.1.9 WorkFlow](#419-workflow)
    - [4.2 APIserver](#42-apiserver)
      - [4.2.1 overview](#421-overview)
      - [4.2.2 访问管理](#422-访问管理)
      - [4.2.3 资源管理](#423-资源管理)
      - [4.2.4 Watch机制](#424-watch机制)
      - [4.2.5 Heartbeat](#425-heartbeat)
    - [4.3 Scheduler](#43-scheduler)
      - [4.3.1 Overview](#431-overview)
      - [4.3.2 Step1: 检查pod状态](#432-step1-检查pod状态)
      - [4.3.3 Step2: 筛选node (filter)](#433-step2-筛选node-filter)
      - [4.3.4 Step3: 评分和排序 (policy)](#434-step3-评分和排序-policy)
      - [4.3.5 Corner case](#435-corner-case)
    - [4.4 Controller](#44-controller)
      - [4.4.1 Overview](#441-overview)
      - [4.4.2 ControllerManager](#442-controllermanager)
      - [4.4.3 ReplicasetController](#443-replicasetcontroller)
      - [4.4.4 ServiceController](#444-servicecontroller)
      - [4.4.5 HPAController](#445-hpacontroller)
      - [4.4.6 JobController](#446-jobcontroller)
    - [4.5 Kubelet](#45-kubelet)
      - [4.5.1 Overview](#451-overview)
      - [4.5.2 运行配置](#452-运行配置)
      - [4.5.3 容器运行时选择](#453-容器运行时选择)
      - [4.5.4 镜像拉取](#454-镜像拉取)
      - [4.5.5 容器生命周期管理](#455-容器生命周期管理)
      - [4.5.5.1 创建](#4551-创建)
      - [4.5.5.2 删除](#4552-删除)
      - [4.5.6 容器资源获取](#456-容器资源获取)
      - [4.5.7 网络](#457-网络)
      - [4.5.8 Pod管理](#458-pod管理)
      - [4.5.9 锁与执行流](#459-锁与执行流)
    - [4.6 KubeProxy](#46-kubeproxy)
      - [4.6.1 Overview](#461-overview)
      - [4.6.2 主要工作](#462-主要工作)
      - [4.6.3 工作原理](#463-工作原理)
    - [4.7 Kubectl](#47-kubectl)
  ...
  - [5. 所有功能](#5-所有功能)
    - [5.1 部署集群](#51-部署集群)
    - [5.2 Pod抽象](#52-pod抽象)
    - [5.3 Service抽象](#53-service抽象)
      - [5.3.1 工作流程](#531-工作流程)
      - [5.3.2 服务类型](#532-服务类型)
      - [5.3.3 使用方法](#533-使用方法)
        - [创建服务](#创建服务)
        - [删除服务](#删除服务)
        - [Pod的创建\&Endpoint的绑定](#pod的创建endpoint的绑定)
        - [示例](#示例)
    - [5.4 ReplicaSet抽象](#54-replicaset抽象)
      - [5.4.1 工作流程](#541-工作流程)
      - [5.4.2 使用方法](#542-使用方法)
        - [创建/修改Repliacaset](#创建修改repliacaset)
        - [扩缩Replicaset](#扩缩replicaset)
        - [删除Repliacaset](#删除repliacaset)
        - [pod的筛选和隔离](#pod的筛选和隔离)
        - [pod异常处理](#pod异常处理)
        - [示例](#示例-1)
    - [5.5 Auto-Scaling](#55-auto-scaling)
      - [5.5.1 工作流程](#551-工作流程)
      - [5.5.2 扩缩容算法](#552-扩缩容算法)
        - [算法流程](#算法流程)
      - [5.5.3 使用方法](#553-使用方法)
        - [创建HPA](#创建hpa)
        - [示例](#示例-2)
    - [5.6 DNS与转发](#56-dns与转发)
      - [5.6.1 Overview](#561-overview)
      - [5.6.2 coreDNS](#562-coredns)
      - [5.6.3 Nginx](#563-nginx)
      - [5.6.4 dnsrecord的更新和删除](#564-dnsrecord的更新和删除)
    - [5.7 容错](#57-容错)
    - [5.8 GPU](#58-gpu)
      - [5.8.1 Job](#581-job)
      - [5.8.2 镜像](#582-镜像)
      - [5.8.3 cuda程序](#583-cuda程序)
    - [5.9 Serverless](#59-serverless)
      - [5.9.1 Overview](#591-overview)
      - [5.9.2 函数的创建、更新和删除](#592-函数的创建更新和删除)
      - [5.9.3 函数的调用和自动扩缩容](#593-函数的调用和自动扩缩容)
      - [5.9.4 Workflow定义和运⾏流程](#594-workflow定义和运流程)
